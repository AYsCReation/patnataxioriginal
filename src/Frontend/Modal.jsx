...
const Modal = ({ setShowModal,  children, setCarType, carType }) => {
    ...
    <div className="modal-overlay">
      ...
      <Slider ref={sliderRef} {...sliderSettings}>
        ...
        <h1 className='slider-item-p'>Chhoti Sawari (Mini Car)</h1>
          <img src={car1} alt="" />
          <button className="BookNow-btn" onClick={()=> {setCarType("Mini")} }>Book Now</button>
        </div>
        <div className="slider-item">
        <h1 className='slider-item-p'>Badi Sawari (Sedan Car) </h1>
        <img src={car2} alt="" />
        <button className="BookNow-btn" onClick={()=> {setCarType("Sedan")} }>Book Now</button>
        </div>
        <div className="slider-item">
        <h1 className='slider-item-p'>Family Sawari (SUV Car) </h1>
        <img src={car3} alt="" />
        <button className="BookNow-btn" onClick={()=> {setCarType("SUV")} }>Book Now</button>
        </div>
